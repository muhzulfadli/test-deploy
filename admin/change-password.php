...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		if ($query->rowCount() > 0) {
			...
			$chngpwd1->execute();
			$msg = "Berhasil mengganti kata sandi";
		} else {
	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i> Ganti Kata Sandi</li>
				</ol>
				<!--grid-->
				<div class="grid-form">
						...
						<div class="panel-body">
							<form name="chngpwd" method="post" class="form-horizontal" onSubmit="return valid();">
								...
								<div class="form-group">
									<label class="col-md-2 control-label">Kata sandi saat ini</label>
									<div class="col-md-8">
								...
								<div class="form-group">
									<label class="col-md-2 control-label">Confirmasi kata sandi</label>
									<div class="col-md-8">
										<div class="input-group">
											<span class="input-group-addon">
												<i class="fa fa-key"></i>
