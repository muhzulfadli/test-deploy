...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		if ($lastInsertId) {
			...
			$error = "Ada yang salah, silahkan ulangi lagi";
		}
	}
	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Tambah Penginapan </li>
				</ol>
				<!--grid-->
				<div class="grid-form">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Detail Penginapan</label>
										<div class="col-sm-8">
