...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_REQUEST['bkid'])) {
		...
		$msg = "Booking berhasil di batalkan";
	}
	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Kelola Pemesanan</li>
				</ol>
									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) {				?>
											<tr>
												...
												?><td>Cancelled</td>
												<?php } else { ?>
													<td><a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid); ?>" onclick="return confirm('Apakah anda ingin membatalkan pesanan ?')">Cancel</a> / <a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid); ?>" onclick="return confirm('Apakah anda ingin mengkonfirmasi pesanan')">Confirm</a></td>
												<?php } ?>
