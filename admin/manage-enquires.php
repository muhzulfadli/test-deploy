...
?>
	...
	<head>
		<title>Kelola Penyebrangan</title>
	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Kelola Penyebrangan</li>
				</ol>
										...
										foreach ($results as $result) {				?>
											<tr>
												...
												<?php } else { ?>
													...
													<td><a href="manage-enquires.php?eid=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Apakah anda ingin mengkonfirmasi ?')">Konfirmasi</a>
													</td>
												<?php } ?>
											</tr>
									<?php }
