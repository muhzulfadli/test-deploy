	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Perbarui Data Halaman</li>
				</ol>
				<!--grid-->
				<div class="grid-form">
							...
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Perbarui Tentang</label>
										<div class="col-sm-8">
											<select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
												<!-- <option value="" selected="selected" class="form-control">***Pilih Salah Satu***</option> -->
									...
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Masukkan Text</label>
										<div class="col-sm-8">
