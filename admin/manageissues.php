	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Kelola Masalah</li>
				</ol>
									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) {				?>
											<tr>
												...
												<td width="100"> <img class="bukti" src="images/<?php echo htmlentities($result->Description); ?>" style="width:90px;"></td>
												<!-- <td> <img src="gambar/<?php echo htmlentities($result->Description); ?>"></td> -->
												<td width="50"><?php echo htmlentities($result->PostingDate); ?></td>


												<!-- <td><a href="javascript:void(0);" onClick="popUpWindow('updateissue.php?iid=<?php echo ($result->id); ?>');">Konfirmasi </a>
												</td> -->
