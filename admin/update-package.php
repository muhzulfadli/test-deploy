	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Ubah Penginapan </li>
				</ol>
				<!--grid-->
				<div class="grid-form">
								...
								if ($query->rowCount() > 0) {
									foreach ($results as $result) {	?>
										...
										<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Nama Penginapan</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Jenis Penginapan</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Keunggulan</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Harga/Malam</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<img src="pacakgeimages/<?php echo htmlentities($result->PackageImage); ?>" width="200">&nbsp;&nbsp;&nbsp;<a href="change-image.php?imgid=<?php echo htmlentities($result->PackageId); ?>">Ganti foto</a>
												</div>
											</div>

											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Data Terakhir di Update</label>
												<div class="col-sm-8">
									...
									<div class="row">
										<div class="col-sm-8 col-sm-offset-2">
											<button type="submit" name="submit" class="btn-primary btn">Ubah</button>
										</div>
									</div>
