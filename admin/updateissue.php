...
?>
  ...
  <body>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr height="50">
            <td colspan="2" class="fontkink2" style="padding-left:0px;">
              <div class="fontpink2"> <b>Tambahkan Pesan</b></div>
            </td>
    ...
    </div><?php } else if ($msg) { ?><div class="succWrap"><strong>BERHASIL</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?></td>
  ...
  <tbody>
    ...
    ?>
          ...
          <tr>
            ...
            <td class="fontkink"> <input type="submit" name="submit2" value="Kirim" size="40" style="cursor: pointer;" /></td>
          </tr>
        <?php } else { ?>
          <tr>
