...
if (strlen($_SESSION['login']) == 0) {
	...
	if (isset($_POST['submit5'])) {
		...
		if ($query->rowCount() > 0) {
			...
			$chngpwd1->execute();
			$msg = "Kata sandi perbarui";
		} else {
			$error = "Aada Kesalahan";
		}
	}
...
?>
	...
	<body>
		...
		<div class="top-header">
			...
			<div class="privacy">
				<div class="container">
					<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Ganti Kata Sandi</h3>
					<form name="chngpwd" method="post" onSubmit="return valid();">
						...
						<p style="width: 350px;">
							...
							<b>Kata sandi saat ini</b> <input type="password" name="password" class="form-control" id="exampleInputPassword1" required="">
						</p>
