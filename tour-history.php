		...
		if ($query->rowCount() > 0) {
			foreach ($results as $result) {
				...
				if ($df > 1) {
					...
					$error = "Anda tidak dapat batalkan pemesanan setelah 24 jam";
				}
			}
		}
	}
...
?>
	...
	<body>
		...
		<div class="top-header">
			...
			<div class="privacy">
				<div class="container">
					<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Riwayat Booking Penginapan</h3>
							...
							if ($query->rowCount() > 0) {
								foreach ($results as $result) {	?>
									<tr align="center">
										...
										?><td>Cancelled</td>
										<?php } else { ?>
											<td><a href="tour-history.php?bkid=<?php echo htmlentities($result->bookid); ?>" onclick="return confirm('Apakah anda ingin membatalkan pesanan')">Cancel</a></td>
										<?php } ?>
									</tr>
							<?php $cnt = $cnt + 1;
								}
